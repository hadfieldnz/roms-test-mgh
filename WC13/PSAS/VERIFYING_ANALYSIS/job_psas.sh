...
#######################################################################
#                                                                     #
# Strong/Weak constraint 4D-PSAS job script: Verifying Analysis       #
#                                                                     #
...
#######################################################################
 ...
 echo ' '
 echo 'Strong/Weak Constraint 4D-PSAS Configuration: Verifying Analysis'
 echo ' '
...
# Copy nonlinear model initial conditions file.
 ...
 cp -vp ${Dir}/PSAS/EX3_RPCG/wc13_dai.nc wc13_ini.nc

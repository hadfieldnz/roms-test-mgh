...
# Copy the forecast trajectories.
 ...
 cp -p ${Dir}/PSAS_forecast_sensitivity/FCSTA/wc13_fwd.nc wc13_fct_A.nc
 cp -p ${Dir}/PSAS_forecast_sensitivity/FCSTB/wc13_fwd.nc wc13_fct_B.nc
 cp -p ${Dir}/PSAS/EX3_RPCG/wc13_fwd_000.nc wc13_fwd_000.nc
...
# Modify 4D-Var template input script and specify above files.
 ...
 $SUBSTITUTE $PSAS roms_oif_a.nc wc13_oifa.nc
 $SUBSTITUTE $PSAS roms_oif_b.nc wc13_oifb.nc

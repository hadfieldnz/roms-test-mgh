...
# many definitions as you want by appending values.
 ...
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DRBL4DVAR_FCT_SENSITIVITY"
...
# etc). Here, the Functionals are two directories back from current.

 export     MY_HEADER_DIR=${MY_PROJECT_DIR}

 Dir=`dirname ${MY_PROJECT_DIR}`

 export MY_ANALYTICAL_DIR=`dirname ${Dir}`/Functionals

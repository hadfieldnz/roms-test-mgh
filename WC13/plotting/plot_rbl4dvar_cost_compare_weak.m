...
Inp1='../RBL4DVAR/EX3_CONGRAD/wc13_mod.nc';     % RBL4D-Var default
...
Inp5='../RBL4DVAR/EX4/wc13_mod.nc';             % RBL4D-Var weak constraint
...
% Weak constraint RBL4DVAR with RPCG
...
if (SINGLE_PLOT),
  ...
  legend('RBL4DVAR','MINRES','RPCG','Weak RPCG','I4DVAR','Location','Northeast');
  ...
  if (PRINT),
    print -dpng -r300 plot_rbl4dvar_cost_weak.png
  end

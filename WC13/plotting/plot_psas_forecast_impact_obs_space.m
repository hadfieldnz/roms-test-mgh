%
% PLOT_PSAS_FCST_IMPACT_OBS_SPACE:  Plots observation impact for forecast
%
...
InpoiA='../PSAS_forecast_impact/Case2/wc13_oifa.nc';
InpoiB='../PSAS_forecast_impact/Case2/wc13_oifb.nc';

Obs  ='../Data/wc13_obs.nc';                           % observation file
Mod  ='../PSAS_forecast_impact/Case2//wc13_mod.nc';    % W4D-PSAS impact file
NLmod='../PSAS/EX3_RPCG/wc13_mod.nc';                  % W4D-PSAS file
...
ylabel('N_{obs}');
title('4D-PSAS Forecast Cycle Observation Impact');
...
if (PRINT)
  png_file='plot_psas_forecast_impact_obs_space.png';

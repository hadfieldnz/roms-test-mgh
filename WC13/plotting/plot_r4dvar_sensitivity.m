%
% This script plots the observation sensitivity for R4D-Var.
%
...
Inpa='../R4DVAR_sensitivity/wc13_ads.nc';

% Observation file.

Obs='../Data/wc13_obs.nc';

% R4D-Var sensitivity mod file.

Mod='../R4DVAR_sensitivity/wc13_mod.nc';

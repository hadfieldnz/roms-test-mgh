...
InpoiA='../RBL4DVAR_forecast_impact/Case2/wc13_oifa.nc';
InpoiB='../RBL4DVAR_forecast_impact/Case2/wc13_oifb.nc';

Obs  ='../Data/wc13_obs.nc';                               % observation file
Mod  ='../RBL4DVAR_forecast_impact/Case2//wc13_mod.nc';    % RBL4D-Var impact file
...
ylabel('N_{obs}');
title('RBL4D-Var Forecast Cycle Observation Impact');
...
if (PRINT)
  png_file='plot_rbl4dvar_forecast_impact_obs_space.png';

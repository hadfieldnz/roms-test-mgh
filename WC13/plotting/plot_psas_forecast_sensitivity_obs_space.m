%
% PLOT_PSAS_FCST_SENSITIVITY_OBS_SPACE:  Plots observation sensitivity
%                                        for forecast
%
...
InpA='../PSAS_forecast_sensitivity/FCSTA/wc13_mod.nc';
InpB='../PSAS_forecast_sensitivity/FCSTB/wc13_mod.nc';
InpO='../Data/forecast_obs.nc';

% Set adjoint forcing arrays in obs space

InpoiA='../PSAS_forecast_sensitivity/Case2/wc13_oifa.nc';
InpoiB='../PSAS_forecast_sensitivity/Case2/wc13_oifb.nc';

Obs  ='../Data/wc13_obs.nc';                              % observation file
Mod  ='../PSAS_forecast_sensitivity/Case2/wc13_mod.nc';   % 4D-PSAS sensitivity file.
NLmod='../PSAS/EX3_RPCG/wc13_mod.nc';                     % 4D-PSAS file
...
if (PRINT)
  png_file='plot_psas_forecast_sensitivity_obs_sensitivity.png';

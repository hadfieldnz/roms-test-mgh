%
% PLOT_PSAS_FCST_SENSITIVITY:  Plots observation sensitivity for forecast
%
...
%   Mod:     W4D-PSAS impact file
%   NLmod:   W4D-PSAS file
%
%   Gname:   Application GRID NetCDF file

InpA='../PSAS_forecast_sensitivity/FCSTA/wc13_fwd.nc';
InpB='../PSAS_forecast_sensitivity/FCSTB/wc13_fwd.nc';
InpVA='../Data/PSAS_VERIFYING_ANALYSIS/wc13_fwd_001.nc';
Obs  ='../Data/wc13_obs.nc';
Mod  ='../PSAS_forecast_sensitivity/Case1/wc13_mod.nc';
...
if (PRINT)
  png_file='plot_psas_forecast_sensitivity.png';
